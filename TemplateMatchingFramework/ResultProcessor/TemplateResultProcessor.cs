...
{
    public class TemplateResultProcessor : IMatchResultProcessor
    {
        [Flags]
        ...
        public bool CanProcess(IMatchInput input, IMatchResult result) => result is TemplateMatchResult;

        public void Process(IMatchInput input, IMatchResult result)
        {
            var calcResult = result as TemplateMatchResult;
